...
[The page on timelines](overview/timeline) is a good place to start learning about jsPsych. 
From there, you might want to complete the [hello world tutorial](tutorials/hello-world) to learn how to set up a jsPsych experiment and the [reaction time experiment tutorial](tutorials/rt-task) to learn the core features of the framework.
