...
For this demo we want to show some text on the screen. This is exactly what the [html-keyboard-response plugin](../plugins/html-keyboard-response) is designed to do. To use the plugin, we need to load it with a `<script>` tag.
