...
| show_progress_bar          | boolean  | If `true`, then [a progress bar](../overview/progress-bar) is shown at the top of the page. Default is `false`. |
...
| Parameter | Type    | Description                              |
| --------- | ------- | ---------------------------------------- |
| timeline  | array   | An array containing the objects that describe the experiment timeline. See [Creating an Experiment: The Timeline](../overview/timeline). |
