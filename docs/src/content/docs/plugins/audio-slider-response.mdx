...
<CodeAndDemo
  ...
  demoLink="/demos/jspsych-audio-slider-response-demo-1.html"
/>

<CodeAndDemo
  title="No response allowed until audio finishes; participant must interact with slider to continue"
  codeText={`var trial = {
	type: jsPsychAudioSliderResponse,
	stimulus: 'sound/speech_joke.mp3',
	labels: ['Not Funny', 'Funny'],
  ...
  demoLink="/demos/jspsych-audio-slider-response-demo-2.html"
/>
