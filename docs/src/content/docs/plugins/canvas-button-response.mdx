...
<CodeAndDemo
  title="Drawing circles based on parameters"
  codeText={`function filledCirc(canvas, radius, color) {
...
var circle_2 = {
  ...
  demoLink="/demos/jspsych-canvas-button-response-demo1.html"
/>

<CodeAndDemo
  title="Using an anonymous stimulus function"
  codeText={`var lines = {
    type: jsPsychCanvasButtonResponse,
    stimulus: function(c) {
  ...
  demoLink="/demos/jspsych-canvas-button-response-demo2.html"
/>

<CodeAndDemo
  title="Using the canvas stimulus function with timeline variables, and recording the correctness of responses"
  codeText={`function filledCirc(canvas, radius, color) {
    var ctx = canvas.getContext("2d");
    ctx.beginPath();
    ctx.arc(150, 150, radius, 0, 2 * Math.PI);
...
var circle_procedure = {
  ...
  demoLink="/demos/jspsych-canvas-button-response-demo3.html"
/>
