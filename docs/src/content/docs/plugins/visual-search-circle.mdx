...
<CodeAndDemo
  title="Identical distractors"
  codeText={`var instructions = {
...
var trial = {
  ...
  demoLink="/demos/jspsych-visual-search-circle-demo1.html"
/>

<CodeAndDemo
  title="Variety of different distractors"
  codeText={`var instructions = {
  type: jsPsychHtmlButtonResponse,
...
var trial = {
  ...
  demoLink="/demos/jspsych-visual-search-circle-demo2.html"
/>
