---
title: 'image-button-response'
---
# image-button-response

Current version: 2.2.0. [See version history](https://github.com/jspsych/jsPsych/blob/main/packages/plugin-image-button-response/CHANGELOG).
