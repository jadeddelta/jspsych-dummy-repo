...
<CodeAndDemo
  title="A classic version of the SRT"
  codeText={`var grid = [
  [1,1,1,1]
]
...
var trial_4 = {
  ...
  demoLink="/demos/jspsych-serial-reaction-time-mouse-demo1.html"
/>

<CodeAndDemo
  title="A 2x2 grid with extra space and different colors"
  codeText={`var grid = [
  [1,0,1],
  [0,0,0],
  [1,0,1]
...
var trial_4 = {
  ...
  demoLink="/demos/jspsych-serial-reaction-time-mouse-demo2.html"
/>
