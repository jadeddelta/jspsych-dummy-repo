...
<CodeAndDemo
  title="Measure distance to screen and pixel ratio; no resizing"
  codeText={`var trial = {
    type: jsPsychVirtualChinrest,
    blindspot_reps: 3,
    resize_units: "none"
};`}
  demoLink="/demos/jspsych-virtual-chinrest-demo1.html"
/>


<CodeAndDemo
  title="Resizing based on centimeters per pixel"
  codeText={`var trial = {
  type: jsPsychVirtualChinrest,
  blindspot_reps: 3,
  resize_units: "cm",
...
var resized_stimulus = {
  ...
  demoLink="/demos/jspsych-virtual-chinrest-demo2.html"
/>

<CodeAndDemo
  title="Resizing based on degrees of visual angle per pixel"
  codeText={`var trial = {
  type: jsPsychVirtualChinrest,
  blindspot_reps: 3,
  resize_units: "deg",
...
var resized_stimulus = {
  ...
  demoLink="/demos/jspsych-virtual-chinrest-demo3.html"
/>
