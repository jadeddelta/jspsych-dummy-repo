---
title: 'canvas-keyboard-response'
---
# canvas-keyboard-response

Current version: 2.1.0. [See version history](https://github.com/jspsych/jsPsych/blob/main/packages/plugin-canvas-keyboard-response/CHANGELOG).
