---
title: 'canvas-button-response'
---
# canvas-button-response

Current version: 2.1.0. [See version history](https://github.com/jspsych/jsPsych/blob/main/packages/plugin-canvas-button-response/CHANGELOG).
