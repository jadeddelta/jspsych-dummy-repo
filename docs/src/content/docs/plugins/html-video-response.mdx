...
<CodeAndDemo
  title="Simple recorded response to a stimulus"
  codeText={`var init_camera = {
...
var trial = {
  ...
  demoLink="/demos/jspsych-html-video-response-demo1.html"
/>

<CodeAndDemo
  title="Allow playback and rerecording"
  codeText={`var init_camera = {
    type: jsPsychInitializeCamera
}
...
var trial = {
  ...
  demoLink="/demos/jspsych-html-video-response-demo2.html"
/>

<CodeAndDemo
  title="Use recorded video as a subsequent stimulus"
  codeText={`var init_camera = {
    type: jsPsychInitializeCamera
}
...
var classify = {
  ...
  demoLink="/demos/jspsych-html-video-response-demo3.html"
/>
