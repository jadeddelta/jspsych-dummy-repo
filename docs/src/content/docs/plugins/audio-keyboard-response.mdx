...
<CodeAndDemo
  title="Trial continues until participant gives a response"
  codeText={`var trial = {
  ...
  demoLink="/demos/jspsych-audio-keyboard-response-demo-1.html"
/>
...
<CodeAndDemo
  ...
  demoLink="/demos/jspsych-audio-keyboard-response-demo-2.html"
/>
