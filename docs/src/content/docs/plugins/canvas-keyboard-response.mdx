...
<CodeAndDemo
  title="Draw rectangle and wait for response"
  codeText={`function drawRect(c){
...
var trial = {
  ...
  demoLink="/demos/jspsych-canvas-keyboard-response-demo1.html"
/>

<CodeAndDemo
  title="Draw circle, no response allowed"
  codeText={`function drawCirc(c){
    var ctx = c.getContext('2d');
    ctx.beginPath();
...
var trial = {
  ...
  demoLink="/demos/jspsych-canvas-keyboard-response-demo2.html"
/>
