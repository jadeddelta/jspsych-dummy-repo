...
<CodeAndDemo
  title="Single question and response"
  codeText={`var trial = {
  ...
  demoLink="/demos/jspsych-survey-text-demo1.html"
/>

<CodeAndDemo
  title="Multiple questions, with an optional placeholder and a required question"
  codeText={`var trial = {
  type: jsPsychSurveyText,
  questions: [
  ...
  demoLink="/demos/jspsych-survey-text-demo2.html"
/>

<CodeAndDemo
  title="Naming questions to improve readability of the stored data"
  codeText={`var trial = {
  type: jsPsychSurveyText,
  questions: [
  ...
  demoLink="/demos/jspsych-survey-text-demo3.html"
/>

<CodeAndDemo
  title="Using the preamble and a longer textbox response"
  codeText={`var trial = {
  type: jsPsychSurveyText,
  ...
  demoLink="/demos/jspsych-survey-text-demo4.html"
/>
