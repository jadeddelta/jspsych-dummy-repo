...
<CodeAndDemo
  title="Draw two squares"
  codeText={`var colors = ['#FF3333', '#FF6A33'];
...
var trial = {
  ...
  demoLink="/demos/jspsych-canvas-slider-response-demo1.html"
/>

<CodeAndDemo
  title="Draw two squares with additional parameters"
  codeText={`var colors;
...
var trial = {
  ...
  demoLink="/demos/jspsych-canvas-slider-response-demo2.html"
/>
