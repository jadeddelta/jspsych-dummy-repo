...
<CodeAndDemo
  title="Simple spoken response to a stimulus"
  codeText={`var trial = {
  ...
  demoLink="/demos/jspsych-html-audio-response-demo1.html"
/>

<CodeAndDemo
  title="Allow playback and rerecording; save data to server immediately"
  codeText={`var trial = {
    type: jsPsychHtmlAudioResponse,
    stimulus: \`
  ...
  demoLink="/demos/jspsych-html-audio-response-demo2.html"
/>

<CodeAndDemo
  title="Use recorded audio as a subsequent stimulus"
  codeText={`var instruction = {
...
var playback = {
  ...
  demoLink="/demos/jspsych-html-audio-response-demo3.html"
/>
