...
<CodeAndDemo
  title="Single page with radiogroup (multiple choice) and checkbox"
  codeText={`const trial = {
  type: jsPsychSurvey,
  survey_json: {
    elements:
      [
  ...
  demoLink="/demos/jspsych-survey-demo1.html"
/>

<CodeAndDemo
  title="Multiple pages with text and multiple choice questions, and more customization"
  codeText={`const trial = {
  type: jsPsychSurvey,
  survey_json: {
  ...
  demoLink="/demos/jspsych-survey-demo2.html"
/>

<CodeAndDemo
  title="Rating and matrix questions for Likert-style scales"
  codeText={`const trial_1 = {
  type: jsPsychSurvey,
  survey_json: {
...
const trial_2 = {
  ...
  demoLink="/demos/jspsych-survey-demo3.html"
/>

<CodeAndDemo
  title="Conditional question visibility based on response"
  codeText={`const survey_function = (survey) => {
...
const trial = {
  ...
  demoLink="/demos/jspsych-survey-demo4.html"
/>

<CodeAndDemo
  title="Repeating survey trials with different variables"
  codeText={`// values that change across survey trials - each object represents a single trial
...
const timeline = jsPsych.randomization.shuffle(survey_trials);`}
  demoLink="/demos/jspsych-survey-demo5.html"
/>

<CodeAndDemo
  title="Adding images, sound and HTML"
  codeText={`// Embed HTML, images, videos and audio into the survey
...
const timeline = [image_video_html_trial, image_choice_trial, sound_trial];`}
  demoLink="/demos/jspsych-survey-demo6.html"
/>

<CodeAndDemo
  title="Automatic formating for text input"
  codeText={`const timeline = [];
...
timeline.push({
  ...
  demoLink="/demos/jspsych-survey-demo7.html"
/>
