---
title: 'virtual-chinrest'
---
# virtual-chinrest

Current version: 3.1.0. [See version history](https://github.com/jspsych/jsPsych/blob/main/packages/plugin-virtual-chinrest/CHANGELOG).
...
::: note[Measure distance to screen and pixel ratio; no resizing]
=== "Code"
    ```javascript
    var trial = {
