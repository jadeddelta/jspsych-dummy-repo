---
title: 'html-keyboard-response'
---
# html-keyboard-response

Current version: 2.1.0. [See version history](https://github.com/jspsych/jsPsych/blob/main/packages/plugin-html-keyboard-response/CHANGELOG).
