...
<CodeAndDemo
  ...
  demoLink="/demos/jspsych-survey-likert-demo1.html"
/>

<CodeAndDemo
  title="Multiple questions in a random order"
  codeText={`var likert_scale = [
  "Strongly Disagree", 
  "Disagree", 
  "Neutral", 
  "Agree", 
...
var trial = {
  ...
  demoLink="/demos/jspsych-survey-likert-demo2.html"
/>
