...
Current version: 1.0.0 [See version history](https://github.com/jspsych/jsPsych/blob/main/packages/plugin-mirror-camera/CHANGELOG).
...
You must initialize the camera using the [initialize-camera plugin](initialize-camera) prior to running this plugin.
