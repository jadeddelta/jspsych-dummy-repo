---
title: 'image-keyboard-response'
---
# image-keyboard-response

Current version: 2.1.0. [See version history](https://github.com/jspsych/jsPsych/blob/main/packages/plugin-image-keyboard-response/CHANGELOG).
...
Image files can be automatically preloaded by jsPsych using the [`preload` plugin](preload). However, if you are using timeline variables or another dynamic method to specify the image stimulus, you will need to [manually preload](../overview/media-preloading.md#manual-preloading) the images.
