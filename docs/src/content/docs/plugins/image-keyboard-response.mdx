...
<CodeAndDemo
  title="Displaying trial until participant gives a response"
  codeText={`var trial = {
  ...
  demoLink="/demos/jspsych-image-keyboard-response-demo1.html"
/>
...
<CodeAndDemo
  ...
  demoLink="/demos/jspsych-image-keyboard-response-demo2.html"
/>
