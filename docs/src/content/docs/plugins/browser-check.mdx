...
<CodeAndDemo
  title="Recording all of the available features, no exclusions"
  codeText={`var trial = {
  type: jsPsychBrowserCheck
};`}
  demoLink="/demos/jspsych-browser-check-demo1.html"
/>

<CodeAndDemo
  title="Using the inclusion function to mandate the use of Chrome or Firefox as the browser"
  codeText={`var trial = {
  type: jsPsychBrowserCheck,
  ...
  demoLink="/demos/jspsych-browser-check-demo2.html"
/>

<CodeAndDemo
  title="Setting a minimum window height & width, with the option to resize the window"
  codeText={`var trial = {
  type: jsPsychBrowserCheck,
  minimum_width: 1000,
  minimum_height: 600
};`}
  demoLink="/demos/jspsych-browser-check-demo3.html"
/>

<CodeAndDemo
  title="Custom exclusion message based on measured features"
  codeText={`var trial = {
  type: jsPsychBrowserCheck,
  inclusion_function: (data) => {
  ...
  demoLink="/demos/jspsych-browser-check-demo4.html"
/>
