...
<CodeAndDemo
  title="Automatically preloading based on other trials"
  codeText={`var preload = {
    type: jsPsychPreload,
    auto_preload: true
}
...
var trial_3 = {
  ...
  demoLink="/demos/jspsych-preload-demo1.html"
/>

<CodeAndDemo
  title="Manually preloading an image"
  codeText={`var preload = {
    type: jsPsychPreload,
...
var trial_1 = {
  ...
  demoLink="/demos/jspsych-preload-demo2.html"
/>

<CodeAndDemo
  title="Loading files in batches"
  codeText={`var jsPsych = initJsPsych();
...
jsPsych.run([preload_block_1, block_1, preload_block_2, block_2])`}
  demoLink="/demos/jspsych-preload-demo3.html"
/>

<CodeAndDemo
  title="Showing a detailed error message for debugging loading issues"
  codeText={`var preload = {
    type: jsPsychPreload,
    images: ['img/bad_file_path.png'],
    show_detailed_errors: true
}`}
  demoLink="/demos/jspsych-preload-demo4.html"
/>
