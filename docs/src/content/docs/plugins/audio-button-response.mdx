...
<CodeAndDemo
  title="Displaying question until participant gives a response"
  codeText={`var trial = {
  ...
  demoLink="/demos/jspsych-audio-button-response-demo-1.html"
/>
...
<CodeAndDemo
  ...
  demoLink="/demos/jspsych-audio-button-response-demo-2.html"
/>

<CodeAndDemo
  title="Setting up a grid-based layout"
  codeText={`const trial = {
  	type: jsPsychAudioButtonResponse,
  ...
  demoLink="/demos/jspsych-audio-button-response-demo-3.html"
/>
