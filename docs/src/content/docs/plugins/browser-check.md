...
Current version: 2.1.0. [See version history](https://github.com/jspsych/jsPsych/blob/main/packages/plugin-browser-check/CHANGELOG).
...
* Support for the Fullscreen API, e.g., through the [fullscreen plugin](../plugins/fullscreen).
...
In [simulation mode](../overview/simulation) the plugin will report the actual features of the browser, with the exception of `vsync_rate`, which is always 60. 
