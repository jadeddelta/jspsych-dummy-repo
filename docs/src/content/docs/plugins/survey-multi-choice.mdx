...
<CodeAndDemo
  title="Vertical Question Alignment"
  codeText={`var trial = {
  ...
  demoLink="/demos/jspsych-survey-multi-choice-demo1.html"
/>

<CodeAndDemo
  title="Horizontal Question Alignment"
  codeText={`var trial = {
  type: jsPsychSurveyMultiChoice,
  questions: [
    {
  ...
  demoLink="/demos/jspsych-survey-multi-choice-demo2.html"
/>
