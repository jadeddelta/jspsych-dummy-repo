...
<CodeAndDemo
  ...
  codeText={`var animation_sequence = ["img/happy_face_1.jpg", "img/happy_face_2.jpg", "img/happy_face_3.jpg", "img/happy_face_4.jpg"];
...
var animation_trial = {
  ...
  demoLink="/demos/jspsych-animation-demo.html"
/>
