...
This page contains the plugin's reference information and examples. The [Building Surveys in jsPsych](../overview/building-surveys) page contains a more detailed guide for using this plugin.
...
You must add one or more SurveyJS "element" to a survey, using the plugin's survey JSON and/or survey function parameter. SurveyJS elements are mostly made up of different question types, but also include non-response content such as HTML and images/video. The [Building Surveys in jsPsych](../overview/building-surveys) page contains more information about how to define survey elements, and you can see some examples in the [Examples section](#examples) on this page.
...
This plugin does not yet support [simulation mode](../overview/simulation).
...
:::note[Single page with radiogroup (multiple choice) and checkbox]
=== "Code"
...
:::
:::note[Multiple pages with text and multiple choice questions, and more customization]
=== "Code"
...
:::
:::note[Rating and matrix questions for Likert-style scales]
...
:::
:::note[Conditional question visibility based on response]
...
:::
:::note[Repeating survey trials with different variables]
...
:::
:::note[Adding images, sound and HTML]
...
:::
:::note[Automatic formating for text input]
