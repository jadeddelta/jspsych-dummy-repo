---
title: 'webgazer-init-camera'
---
# webgazer-init-camera

Current version: 2.1.0. [See version history](https://github.com/jspsych/jsPsych/blob/main/packages/plugin-webgazer-init-camera/CHANGELOG).
