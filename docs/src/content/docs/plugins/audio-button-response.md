---
title: 'audio-button-response'
---
# audio-button-response

Current version: 2.1.1. [See version history](https://github.com/jspsych/jsPsych/blob/main/packages/plugin-audio-button-response/CHANGELOG).
...
Audio files can be automatically preloaded by jsPsych using the [`preload` plugin](preload). However, if you are using timeline variables or another dynamic method to specify the audio stimulus, you will need to [manually preload](../overview/media-preloading.md#manual-preloading) the audio.
