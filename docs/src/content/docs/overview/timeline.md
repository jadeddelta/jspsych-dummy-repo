...
To create and run a simple experiment like this complete the [hello world tutorial](../tutorials/hello-world).
...
What follows is an example of how to use timeline variables. The [simple reaction time tutorial](../tutorials/rt-task) also explains how to use timeline variables.
