...
As of v7.1 of jsPsych, the recommended way to do this is using the [browser-check plugin](../plugins/browser-check). 
...
Please see the [browser-check plugin documentation](../plugins/browser-check) for more details.
